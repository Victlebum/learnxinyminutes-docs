...
Go-tietämyksen alku ja juuri on sen [virallinen verkkosivu]()(http://go.dev/).
...
Go:n opiskelijoiden lukulistalla on [oletuskirjaston lähdekoodi](http://go.dev/src/pkg/).
Kattavasti dokumentoituna se antaa parhaan kuvan helppolukuisesta ja ymmärrettävästä Go-koodista,
-tyylistä ja -tavoista. Voit klikata funktion nimeä [doukumentaatiossa](http://go.dev/pkg/) ja
