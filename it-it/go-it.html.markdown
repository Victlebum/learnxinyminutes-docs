...
La risorsa più importante per imparare il Go è il [sito ufficiale di Go](http://go.dev/).
...
sorgente della libreria standard](http://go.dev/src/pkg/). Infatti è
...
funzione [nella documentazione](http://go.dev/pkg/) compare il relativo
codice sorgente!
