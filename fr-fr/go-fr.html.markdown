...
La référence Go se trouve sur [le site officiel de Go](http://go.dev/).
...
librairie standard](http://go.dev/src/pkg/). Bien documentée, elle démontre
...
documentation](http://go.dev/pkg/) et le code source apparaît!
