...
Vše hlavní o Go se nachází na [oficiálních stránkách go](http://go.dev/).
...
Na vašem knižním seznamu, by neměly chybět [zdrojáky stadardní knihovny](http://go.dev/src/pkg/).
Důkladně popisuje a dokumentuje Go, styl zápisu Go a Go idiomy. Pokud kliknete na [dokumentaci](http://go.dev/pkg/)
