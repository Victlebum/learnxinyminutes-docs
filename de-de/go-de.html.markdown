...
## Weitere Resourcen
Informationen zu Go findet man auf der [offiziellen Go Webseite](http://go.dev/).
...
ist außerdem der Quelltext der [Go standard Bibliothek](http://go.dev/src/pkg/)
...
in der [offiziellen Dokumentation von Go](http://go.dev/pkg/).
