...
A principal fonte de informação é o [web site oficial Go](http://go.dev/).
...
biblioteca padrão](http://go.dev/src/pkg/). Exaustivamente documentado, é
...
(http://go.dev/pkg/) e veja o código fonte aparecer!
