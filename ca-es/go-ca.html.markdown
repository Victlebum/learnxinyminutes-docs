...
(http://go.dev/). Allà es pot seguir el tutorial, jugar interactivament
...
[el codi font de la llibreria estàndard](http://go.dev/src/pkg/).
...
pot clicar en un nom de funció en [la documentació](http://go.dev/pkg/)
i veure'n el codi!
